package org.example.krestiki_noliki.runner;

import org.example.krestiki_noliki.model.Player;
import org.example.krestiki_noliki.service.Play;
...
public class PlayRunner {
    public static void run() {
        ...
        play.getPlay();
//        sc.close(); //TODO: почему возникают исключение при закрытии сканнера здесь или в методе doMove()?
    }
}
